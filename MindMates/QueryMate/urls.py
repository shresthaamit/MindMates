...
from .views import TagViewset, QuestionViewset, AnswerViewset,ReviewViewset
...
questions_router.register('answers', AnswerViewset, basename='question-answers')
answers_router = nested_routers.NestedSimpleRouter(questions_router, 'answers', lookup='answer')
answers_router.register('reviews', ReviewViewset, basename='answer-reviews')
urlpatterns = [
    path('', include(router.urls)),
    path('', include(questions_router.urls)),
